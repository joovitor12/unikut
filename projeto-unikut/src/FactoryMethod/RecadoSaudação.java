 ...
 * @author j-vit
 */
public class RecadoSaudação implements RecadoInterface{
    ...
    public void enviaRecados(List<Usuario> usuarios) {
        ...
        if (retornaUsuario(meuLogin, usuarios) == null) {
            ...
            if (conta == null) {
                ...
                System.out.println(ANSI_YELLOW + "Você escolheu o tópico saudação!" + ANSI_RESET);
                        ...
                        models.Recado mensagemJogos = new models.Recado(recadoJogos, retornaUsuario(meuLogin, usuarios).getLogin(), "Saudação");
                        recadosJogos.add(mensagemJogos);
                        System.out.println(ANSI_GREEN + "MENSAGEM ENVIADA!" + ANSI_RESET);
                        System.out.println(ANSI_YELLOW + "TÓPICO: SAUDAÇÃO." + ANSI_RESET);
            }
        }
    }
    }
