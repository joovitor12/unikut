...
import static controllers.controllerUsuario.acessaConta;
...
public class view {
    ...
    Scanner in = new Scanner(System.in);
        ...
        criaConta create = new criaConta();
        menuAdm acessoAdm = new menuAdm();
        ContaAdm admin = new ContaAdm();
        admin.setLogin("admin");
        admin.setNome("Administrador");
        admin.setSenha("123");
        admin.setBio("Olá eu sou o administrador");
        ...
        do {       
            ...
            switch (op) {
                ...
                case 3:
                    ...
                    in.nextLine();
                   ContaAdm admLogin = (ContaAdm) buscaUsuarioLogin(loginSecreto, usuariosSistema);
                    if (admLogin != null) {
                        System.out.println(ANSI_GREEN + "Informe a senha: " + ANSI_RESET);
                        String senhaSecreta = in.nextLine();
                        if (senhaSecreta.equals(admLogin.getSenha())) {
                            ContaAdm acesso = (ContaAdm) acessaConta(admLogin, usuariosSistema);
                            if (acesso != null) {
                                System.out.println(ANSI_GREEN + "O PERFIL ESTÁ SENDO ACESSADO..." + ANSI_RESET);
