...
public class RecadoSeries implements RecadoInterface {
   @Override
        ...
        if (retornaUsuario(meuLogin, usuarios) == null) {
            ...
            if (conta == null) {
                ...
                System.out.println(ANSI_YELLOW + "Você escolheu o tópico séries!" + ANSI_RESET);
                        ...
                        models.Recado mensagemJogos = new models.Recado(recadoJogos, retornaUsuario(meuLogin, usuarios).getLogin(), "Séries");
